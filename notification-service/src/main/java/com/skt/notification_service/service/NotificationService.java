package com.skt.notification_service.service;
...
public class NotificationService {
    ...
    // ADDED 'final' HERE — now Lombok includes this in the constructor and Spring injects it
    private final JavaMailSender javaMailSender;

    @KafkaListener(topics = "order-placed")
    public void orderListen(OrderPlacedEvent orderPlacedEvent) {
